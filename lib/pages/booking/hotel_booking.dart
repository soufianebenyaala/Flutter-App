...
class HotelBooking extends StatefulWidget {
  const HotelBooking({Key? key, required this.hebergement}) : super(key: key);
...
class _HotelBookingState extends State<HotelBooking> {
  ...
  void initState() {
    ...
    _initialPosition = CameraPosition(
      target: LatLng(widget.hebergement.latitude, widget.hebergement.longitude),
      zoom: 14.4746,
    );
    ...
    markers.add(Marker(
        ...
        position:
            LatLng(widget.hebergement.latitude, widget.hebergement.longitude)));
  ...
  updatePrice() {
    setState(() {
      finalPrice = double.parse(_childrenLess4Controller.text) *
              widget.hebergement.prixEnfantMoin4 +
          double.parse(_childrenController.text) *
              widget.hebergement.prixEnfantPlus4 +
          double.parse(_adultsController.text) * widget.hebergement.prixAdulte;
    });
  }
  ...
  handleBooking() async {
    ...
    AccomadationReservationData resData = AccomadationReservationData(
      accomadationId: widget.hebergement.id!,
      canceled: 0,
    ...
    var r = await UserManager.reserveAccomadation(resData);
